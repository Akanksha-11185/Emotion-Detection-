    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 pt-16">
      ...
      <div className="container mx-auto px-4 py-6 mt-4">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-slate-400 mt-4">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50 hover:border-blue-500/50 transition-all hover:shadow-lg hover:shadow-purple-500/20">
            <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-4">
