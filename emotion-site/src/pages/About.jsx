  ...
  return (
    <div className="pt-20 pb-16 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 min-h-screen">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-slate-400 max-w-4xl mb-6 leading-relaxed">
        ...
        <ul className="list-disc list-inside text-slate-400 space-y-2 mb-12">
        ...
        <p className="text-slate-400 max-w-4xl mb-12 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-5 p-6 rounded-xl bg-slate-800/30 border border-slate-700/50
            ...
            >
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 p-1">
                <div className="w-full h-full rounded-full bg-slate-900 flex items-center justify-center text-2xl font-semibold text-blue-400">
                  {member.name[0]}
                </div>
              </div>
