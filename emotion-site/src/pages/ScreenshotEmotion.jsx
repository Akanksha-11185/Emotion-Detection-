...
export default function ScreenshotEmotion() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-white pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {!preview ? (
              <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-100 p-8 hover:shadow-2xl hover:border-blue-200 transition-all">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Quick & Secure</p>
                  </div>
                </div>
                ...
                <label
                  ...
                  className={`relative block w-full cursor-pointer transition-all ${
                    dragActive
                      ...
                      : "border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 hover:border-blue-400 hover:shadow-lg"
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl hover:scale-105">
                ...
                {error && (
                  <div className="mt-6 flex items-center gap-3 p-4 bg-red-50 border-2 border-red-200 rounded-xl">
              ...
              <>
                <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-100 p-8 hover:shadow-2xl transition-all">
                  ...
                  <div className="relative rounded-xl overflow-hidden border-2 border-blue-100 bg-slate-50">
                    <img
                      src={preview}
                      alt="preview"
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl shadow-xl p-8 text-white sticky top-24">
        ...
        {result && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom duration-500">
              ...
              <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-100 p-8 hover:shadow-2xl transition-all">
                ...
                <div className="space-y-4">
                  {result.messages.map((msg, idx) => (
                    <div
                      key={idx}
                      className="p-4 bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl border-2 border-blue-100 hover:border-blue-200 transition-all"
                    >
            ...
            <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-100 p-8 hover:shadow-2xl transition-all">
              ...
              <div className="p-6 bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl border-2 border-blue-100">
